...
function Hero() {
  ...
  return (
    ...
    <TooltipProvider delayDuration={100}>
      ...
      <div className="search-container w-full max-w-2xl p-1 continer mt-5 rounded-2xl relative">
        <textarea
          placeholder="Turn imagination into websites that work your way."
          value={userInput}
          onChange={(event) => setUserInput(event.target.value)}
          className="input w-full p-3 pr-14 bg-[#ffffff] top-0.5 relative rounded-lg resize-none focus:outline-none"
          style={{ height: "144px" }}
        />
      ...
      <div className="mt-4 flex items-center gap-3">
        ...
        {suggestions.map((suggestion, index) => (
          <div className="sp" key={index}>
            <button className="group flex items-center w-full gap-2 justify-center bg-transparent text-bolt-elements-textTertiary hover:text-bolt-elements-textPrimary transition-theme"
